...
class ElectricPhotoetching(ElectricBase):
	"""光刻机逻辑"""
	def __init__(self, severHandler, blockName, pos, dimension, param={}):
		super(ElectricPhotoetching, self).__init__(severHandler, blockName, pos, dimension, param)
	...
	def Destroy(self, breaks=False):
		...
		# 解除占用
		self.SetUseKw(False)
		super(ElectricPhotoetching, self).Destroy(breaks)
		pass
