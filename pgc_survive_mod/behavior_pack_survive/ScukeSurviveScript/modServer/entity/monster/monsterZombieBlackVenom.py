...
class MonsterZombieBlackVenom(EntityBase):
	"""黑色毒液僵尸"""
	
	def __init__(self, severHandler, entityId, engineTypeStr=None, param={}):
		super(MonsterZombieBlackVenom, self).__init__(severHandler, entityId, engineTypeStr, param)
	...
	def Destroy(self):
		super(MonsterZombieBlackVenom, self).Destroy()
