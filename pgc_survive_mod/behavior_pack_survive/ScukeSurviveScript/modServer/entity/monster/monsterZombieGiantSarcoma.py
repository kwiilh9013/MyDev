...
class MonsterZombieGiantSarcoma(EntityBase):
	"""黑色毒液僵尸"""
	
	def __init__(self, severHandler, entityId, engineTypeStr=None, param={}):
		super(MonsterZombieGiantSarcoma, self).__init__(severHandler, entityId, engineTypeStr, param)
	...
	def Destroy(self):
		super(MonsterZombieGiantSarcoma, self).Destroy()
