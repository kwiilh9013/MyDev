...
class ElectricHeaterLargeUI(ModBaseUI):
	"""取暖器UI"""
	def __init__(self, namespace, name, param):
		super(ElectricHeaterLargeUI, self).__init__(namespace, name, param)
	...
	def Destroy(self):
		super(ElectricHeaterLargeUI, self).Destroy()
		Instance.mEventMgr.UnRegisterEvent(eventConfig.ElectricUISubscriptEvent, self.ElectricUISubscriptEvent)
		pass

	def Create(self):
		super(ElectricHeaterLargeUI, self).Create()
		# 小太阳UI
		heaterSmallPanel = self.GetBaseUIControl("/panel_heater_large")
