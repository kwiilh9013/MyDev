...
Config = {
	'identifier': 'scuke_survive:melee_chainsaw_old',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_chainsaw_old',
			'texture': 'textures/models/scuke_survive/melee/melee_chainsaw_old',
			'renderController': 'controller.render.scuke_survive_melee_chainsaw_old',
			'hands': {
