...
Config = {
	'identifier': 'scuke_survive:melee_axe',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_axe',
			'texture': 'textures/models/scuke_survive/melee/melee_axe',
			'renderController': 'controller.render.scuke_survive_melee_axe',
			'hands': {
