...
Config = {
	'identifier': 'scuke_survive:melee_pigsaw_golden',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_pigsaw_golden',
			'texture': 'textures/models/scuke_survive/melee/melee_pigsaw_golden',
			'renderController': 'controller.render.scuke_survive_melee_pigsaw_golden',
			'hands': {
