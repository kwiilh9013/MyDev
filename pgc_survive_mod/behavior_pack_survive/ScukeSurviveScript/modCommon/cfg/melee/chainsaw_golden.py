...
Config = {
	'identifier': 'scuke_survive:melee_chainsaw_golden',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_chainsaw_golden',
			'texture': 'textures/models/scuke_survive/melee/melee_chainsaw_golden',
			'renderController': 'controller.render.scuke_survive_melee_chainsaw_golden',
			'hands': {
