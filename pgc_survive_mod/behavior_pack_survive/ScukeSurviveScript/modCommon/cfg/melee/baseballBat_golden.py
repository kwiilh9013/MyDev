...
Config = {
	'identifier': 'scuke_survive:melee_baseball_bat_golden',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_baseball_bat_golden',
			'texture': 'textures/models/scuke_survive/melee/melee_baseball_bat_golden',
			'renderController': 'controller.render.scuke_survive_melee_baseball_bat_golden',
			'hands': {
