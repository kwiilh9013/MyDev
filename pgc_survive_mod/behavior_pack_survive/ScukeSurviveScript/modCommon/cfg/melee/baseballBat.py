...
Config = {
	'identifier': 'scuke_survive:melee_baseball_bat',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_baseball_bat',
			'texture': 'textures/models/scuke_survive/melee/melee_baseball_bat',
			'renderController': 'controller.render.scuke_survive_melee_baseball_bat',
			'hands': {
