...
Config = {
	'identifier': 'scuke_survive:melee_pan_copper',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_pan_copper',
			'texture': 'textures/models/scuke_survive/melee/melee_pan_copper',
			'renderController': 'controller.render.scuke_survive_melee_pan_copper',
			'hands': {
