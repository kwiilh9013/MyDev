...
Config = {
	'identifier': 'scuke_survive:melee_axe_golden',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_axe_golden',
			'texture': 'textures/models/scuke_survive/melee/melee_axe_golden',
			'renderController': 'controller.render.scuke_survive_melee_axe_golden',
			'hands': {
