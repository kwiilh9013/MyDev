...
Config = {
	'identifier': 'scuke_survive:melee_pan',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_melee_pan',
			'texture': 'textures/models/scuke_survive/melee/melee_pan',
			'renderController': 'controller.render.scuke_survive_melee_pan',
			'hands': {
