...
Config = {
	'identifier': 'scuke_survive:gun_sniper1_s1',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_gun_sniper1_s1',
			'texture': 'textures/entity/scuke_survive/gun/gun_sniper1_grain_s1',
			'renderController': 'controller.render.scuke_survive_gun_sniper1_s1',
			'mat': {
