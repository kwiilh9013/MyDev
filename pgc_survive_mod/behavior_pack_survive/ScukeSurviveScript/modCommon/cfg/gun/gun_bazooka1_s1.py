...
Config = {
	'identifier': 'scuke_survive:gun_bazooka1_s1',
	...
	'shootEffect': {
		'identifier': 'scuke_survive:bullet_bazooka1_s1',
		'type': 'projectile',
		'lifeTime': 10.0,
		'hitEffect': {
			'type': 'explosion',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_gun_bazooka1_s1',
			'texture': 'textures/entity/scuke_survive/gun/gun_bazooka1_grain_s1',
			'renderController': 'controller.render.scuke_survive_gun_bazooka1_s1',
			'mat': {
		...
		'particle': {
			'gun_fire': 'scuke_survive:gun_bazooka1_s1_fire',
			'gun_firespark': 'scuke_survive:gun_bazooka1_s1_firespark',
			'hit_static': 'scuke_survive:gun_bazooka1_s1_hit',
			'hit_target': 'scuke_survive:gun_bazooka1_s1_hit',
		},
		'sound': {
