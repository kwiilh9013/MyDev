...
Config = {
	'identifier': 'scuke_survive:gun_bazooka1',
	...
	'shootEffect': {
		'identifier': 'scuke_survive:bullet_bazooka1',
		'type': 'projectile',
		'lifeTime': 10.0,
		'hitEffect': {
			'type': 'explosion',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_gun_bazooka1_s3',
			'texture': 'textures/entity/scuke_survive/gun/gun_bazooka1_grain',
			'renderController': 'controller.render.scuke_survive_gun_bazooka1_s3',
			'mat': {
		...
		'particle': {
			'gun_fire': 'scuke_survive:gun_bazooka1_s3_fire',
			'gun_firespark': 'scuke_survive:gun_bazooka1_s3_firespark',
			'hit_static': 'secuke_survive:gun_bazooka1_s3_hit',
			'hit_target': 'scuke_survive:gun_bazooka1_s3_hit',
		},
		'sound': {
