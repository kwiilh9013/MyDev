...
Config = {
	'identifier': 'scuke_survive:gun_smg1_s2',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_gun_smg1_s2',
			'texture': 'textures/entity/scuke_survive/gun/gun_smg1_grain_s2',
			'renderController': 'controller.render.scuke_survive_gun_smg1_s2',
			'mat': {
		...
		'particle': {
			'trail': {
				'first': {
					'name': 'scuke_survive:gun_smg1_s2_trail',
					'offset': [0, 0.375, 0]
				},
				'first_zoom': {
					'name': 'scuke_survive:gun_smg1_s2_trail_zoom',
					'offset': [0, 0.375, 0]
				},
				'third': {
					'name': 'scuke_survive:gun_smg1_s2_trail',
			...
			'gun_fire': 'scuke_survive:gun_smg1_s2_fire',
			'gun_firespark': 'scuke_survive:gun_smg1_s2_firespark',
			'hit_static': 'scuke_survive:gun_smg1_s2_hit',
			'hit_drop': 'scuke_survive:gun_smg1_s2_hitdrop',
			'hit_target': 'scuke_survive:gun_smg1_s2_hit',
		},
		'sound': {
