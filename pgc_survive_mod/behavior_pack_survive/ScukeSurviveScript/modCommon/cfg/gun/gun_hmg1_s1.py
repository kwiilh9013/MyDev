...
Config = {
	'identifier': 'scuke_survive:gun_hmg1_s1',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_gun_hmg1_s1',
			'texture': 'textures/entity/scuke_survive/gun/gun_hmg1_grain_s1',
			'renderController': 'controller.render.scuke_survive_gun_hmg1_s1',
			'mat': {
		...
		'particle': {
			'trail': {
				'first': {
					'name': 'scuke_survive:gun_hmg1_s1_trail',
					'offset': [0, 0.18, 0]
				},
				'first_zoom': {
					'name': 'scuke_survive:gun_hmg1_s1_trail_zoom',
					'offset': [0, 0.18, 0]
				},
				'third': {
					'name': 'scuke_survive:gun_hmg1_s1_trail',
			...
			'gun_fire': 'scuke_survive:gun_hmg1_s1_fire',
			'gun_firespark': 'scuke_survive:gun_hmg1_s1_firespark',
			'hit_static': 'scuke_survive:gun_hmg1_s1_hit',
			'hit_drop': 'scuke_survive:gun_hmg1_s1_hitdrop',
			'hit_target': 'scuke_survive:gun_hmg1_s1_hit',
		},
		'sound': {
