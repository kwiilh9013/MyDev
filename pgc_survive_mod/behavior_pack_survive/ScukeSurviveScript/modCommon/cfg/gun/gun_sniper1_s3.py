...
Config = {
	'identifier': 'scuke_survive:gun_sniper1',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_gun_sniper1_s3',
			'texture': 'textures/entity/scuke_survive/gun/gun_sniper1_grain',
			'renderController': 'controller.render.scuke_survive_gun_sniper1_s3',
			'mat': {
