...
Config = {
	'identifier': 'scuke_survive:gun_rifle1',
	...
	'display': {
		...
		'animator': {
			...
			'textureKey': 'scuke_survive_gun_rifle1_s3',
			'texture': 'textures/entity/scuke_survive/gun/gun_rifle1_grain',
			'renderController': 'controller.render.scuke_survive_gun_rifle1_s3',
			'mat': {
		...
		'particle': {
			'trail': {
				'first': {
					'name': 'scuke_survive:gun_rifle1_s3_trail',
					'offset': [0, 0.25, 0]
				},
				'first_zoom': {
					'name': 'scuke_survive:gun_rifle1_s3_trail_zoom',
					'offset': [0, 0.25, 0]
				},
				'third': {
					'name': 'scuke_survive:gun_rifle1_s3_trail',
			...
			'gun_fire': 'scuke_survive:gun_rifle1_s3_fire',
			'gun_firespark': 'scuke_survive:gun_rifle1_s3_firespark',
			'hit_static': 'scuke_survive:gun_rifle1_s3_hit',
			'hit_drop': 'scuke_survive:gun_rifle1_s3_hitdrop',
			'hit_target': 'scuke_survive:gun_rifle1_s3_hit',
		},
		'sound': {
