...
from ScukeConvertTableScript.modCommon.manager.commonMgr import CommonManager
...
class UIManagerGac(CommonManager):
	...
	def UiInitFinished(self, args):
		...
		# 转化桌可拖动hud
		self.RegisterUI(UIDef.UI_TableHud)
		self.CreateUI(UIDef.UI_TableHud,{"isHud": 1})

		# 转化桌主界面
		self.RegisterUI(UIDef.UI_TableMain)

		# 转换桌其他界面
		self.RegisterUI(UIDef.UI_TableTeamManager)
		self.RegisterUI(UIDef.UI_TableExchangeRecord)
		self.RegisterUI(UIDef.UI_TableMakePrice)
		self.RegisterUI(UIDef.UI_TableNotice)
		self.RegisterUI(UIDef.UI_TableSetting)
		self.RegisterUI(UIDef.UI_TableTiming)
